...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=9915&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/argo-workflows-dsl-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `argo-workflows-dsl` can be installed with:

```
conda install argo-workflows-dsl
```

It is possible to list all of the versions of `argo-workflows-dsl` available on your platform with:
